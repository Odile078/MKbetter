...
$(document).ready(function(){
  ...
  $('#addcomment').click(function(){
    $(this).append("<h5>Leave a Comment</h2><form><input type='text' id='commentername'><textarea placeholder='Add Your Comment'></textarea><br><div class='btn'><input type='submit' value='Comment'><button id='clear' >Cancel</button></div></form>");
  })
